...
class MyLists(MethodView):
    ...
    def delete(self):
        ...
        connection.commit()
        return ({"Success": "Deleted all your lists successfully"}, 200)
...
class SingleList(MethodView):
    ...
    #     print("In my Options method")
    #     return ({"Good": "Finally"}, 200)
    ...
    def get(self, list_id):
        ...
        response = make_response(json.dumps(movies), 200)
        response.mimetype = 'application/json'
        return response
    ...
    def patch(self, list_id):
        ...
        connection.commit()
        return ({"Success": "List name updated successfully"}, 200)
